...
استخدم هذه المهارة لإضافة طبقة **Bias Audit & Fairness Interlock** قبل أي قرار آلي قد يؤثر في أشخاص أو فرص أو وصول أو ترتيب أو نشر. لا تفترض أن النموذج محايد، ولا تدّعِ الوصول إلى حياد مطلق؛ أنشئ حكمًا قابلًا للتدقيق يوضح ما اختُبر، وما لم يُختبر، وحدود النتيجة.
